...
export class Artifact {
    ...
    public set level (value: Level | undefined) {
      this._level = value
      if (this._mainstat !== undefined && this._level !== undefined) { this._mainstatValue = this._level * (mainStatValues[this._mainstat][1] - mainStatValues[this._mainstat][0]) / 20 + mainStatValues[this._mainstat][0] }
    }
    ...
    public set mainstatValue (value: number | undefined) {
      ...
      if (this._mainstat !== undefined && this._level !== undefined && value !== undefined) { this._level = Math.round(20 * (value - mainStatValues[this._mainstat][0]) / (mainStatValues[this._mainstat][1] - mainStatValues[this._mainstat][0])) as Level }
    }
    ...
    public get scoreDfltSubstats (): number | undefined {
      if (this._substats !== null && this !== null ) {
        let sumWeight = 0
        this._substats.forEach((sub) => {
